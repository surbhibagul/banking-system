...
<nav class="navbar navbar-expand-lg ">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="transaction.php">Trasaction History</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container">
        ...
        <form method="post" name="tcredit" class="tabletext"><br>
            <div>
                <table class="table table table-dark table-striped widt">
                    <tr>
            ...
            <div class="text-center">
                <button class="btn mt-3" name="submit" type="submit" id="myBtn" style="background-color : yellow; padding: 10px; border-radius: 15px;">Transfer Money</button>
            </div>
        </form>
    </div>
